...
app.use(express.static(__dirname + '/scripts/bootstrap.min.js'));
app.use(express.static(__dirname + '/scripts/jquery-1.12.3.min.js'));
app.use(express.static(__dirname + '/scripts/main.js'));
